...
public class pharmear_setup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setup_background.setBackground(new java.awt.Color(0, 145, 173));

        jPanel1.setBackground(new java.awt.Color(248, 150, 30));

        jButton1.setBackground(new java.awt.Color(36, 130, 119));
        jButton1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("MySQL Connection");
        jButton1.setBorder(null);

        jButton2.setBackground(new java.awt.Color(20, 116, 111));
        jButton2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButton2.setForeground(new java.awt.Color(255, 255, 255));
        jButton2.setText("User Add");
        jButton2.setBorder(null);

        jButton3.setBackground(new java.awt.Color(3, 102, 102));
        jButton3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setText("Store Details");
        jButton3.setBorder(null);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mms/src/icon_40px.png"))); // NOI18N

        jPanel2.setBackground(new java.awt.Color(234, 53, 70));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Phaemear Setup");
        ...
        mysql_panelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, mysql_panelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(mysql_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jSeparator1, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(mysql_conn_seperator, javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, mysql_panelLayout.createSequentialGroup()
        ...
        jTabbedPane1.addTab("tab2", mysql_panel);
        ...
        jTabbedPane1.addTab("tab1", new_user_panel);
        ...
        jScrollPane1.setViewportView(setup_background);
