...
public class mysql {
    ...
    public static boolean main(String args[]) {
        String db_url = "jdbc:mysql://localhost:3306/pharmear_db";
    ...
    public static void medicine_delete(String medicine_id, String medicine_batch) throws SQLException {
        ...
        float temp_cost = 0;
        stmt = connect.createStatement();
        String query = "SELECT total_stock, total_cost FROM medicine_stock where med_batch = " + medicine_batch + "";
        result = stmt.executeQuery(query);
        while (result.next()) {
    ...
    public static void bar_finder() throws SQLException {
        stmt = connect.createStatement();
        String query = "SELECT sum(total_stock), sum(total_cost), sum(sold_stock), sum(sold_cost) FROM medicine_stock;";
        result = stmt.executeQuery(query);
        while (result.next()) {
    ...
    public static void backup_pharmear_db() throws SQLException {
        ...
        try {
            ...
            process_backup = run_pharmear_backup.exec("C:/Program Files/MySQL/MySQL Server 8.0/bin/mysqldump -uroot -p" + mms.db_passcode + " --add-drop-database -B pharmear_db -r" + backup_path);
    ...
    public static void restore_from_setup(String restore_path) throws SQLException, IOException {
        ...
        String[] restoreCmd = new String[]{"C:/Program Files/MySQL/MySQL Server 8.0/bin/mysql ", "--user=root", "--password=" + pharmear_setup.db_code_write, "pharmear_db", "-e", "source " + restore_path};
    ...
    public static boolean user_add(String setup_user_name, String setup_user_type, String setup_username, String setup_password, int setup_code) throws SQLException {
        ...
        String query_user = "use pharmear_db;";
